<?php
define('DEMO', 'multiserve-animations');

?>
<!DOCTYPE html>
<html>
    <head>
        <title>Demo Multiserve Animations | BttrLazyLoading</title>
    ...
    <body>
        <div class="container">
            <div class="jumbotron">
                <h1>Multiserve animations</h1>
                <p>BttrLazyLoading allow you to have a specific animation per device.</p>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <h2>HTML</h2>
