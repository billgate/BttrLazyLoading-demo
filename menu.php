<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation" data-spy="affix" data-offset-top="0">
    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="nav navbar-nav">
			<li style="margin-top: 8px;"><iframe src="http://ghbtns.com/github-btn.html?user=shprink&repo=bttrlazyloading&type=watch&count=true&size=large" height="20" width="170" frameborder="0" scrolling="0" style="width:130px; height: 30px;" allowTransparency="true"></iframe></li>
			<li class="dropdown">
				<a href="../" class="dropdown-toggle" data-toggle="dropdown">Presentation & API <b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a class="smooth-scroll" href="/">Presentation</a></li>
					<li><a class="smooth-scroll" href="/#options">Options</a></li>
					<li><a class="smooth-scroll" href="/#demos" >Options demo</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="/demo/one-image.php">One image</a></li>
                    <li><a href="/demo/several-images.php">Several images</a></li>
                    <li><a href="/demo/different-sizes.php">Different size</a></li>
                    <li><a href="/demo/animations.php">Animations</a></li>
                    <li><a href="/demo/dynamic-loading.php">Dynamic loading</a></li>
                </ul>
            </li>
