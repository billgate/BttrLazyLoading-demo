        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-lg-6">
                    <img id="img-not-bad" class="bttrlazyloading" data-bttrlazyloading-xs-src="http://julienrenaux.fr/wp-content/uploads/2013/12/bttrlazyloading-710x428.png" data-bttrlazyloading-xs-width="698" data-bttrlazyloading-xs-height="421" data-bttrlazyloading-sm-src="http://julienrenaux.fr/wp-content/uploads/2013/12/bttrlazyloading-710x428.png"
                    data-bttrlazyloading-sm-width="335" data-bttrlazyloading-sm-height="202" data-bttrlazyloading-md-src="http://julienrenaux.fr/wp-content/uploads/2013/12/bttrlazyloading-710x428.png" data-bttrlazyloading-md-width="445" data-bttrlazyloading-md-height="268"
                    data-bttrlazyloading-lg-src="http://julienrenaux.fr/wp-content/uploads/2013/12/bttrlazyloading-710x428.png" data-bttrlazyloading-lg-width="545" data-bttrlazyloading-lg-height="329" />
                    <script type="text/javascript">
                        $(function() {
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-lg-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>BttrLazyLoading makes sure that you always have the appropriate image loaded for any type of screen: phones (
                                <768px), tablets (≥768px), desktops (≥992px) and large Desktops (≥1200px).</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-3">
            ...
            <section id="options">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><a href="#demo-delay" class="smooth-scroll">delay</a>
                            </td>
                            <td class="hidden-xs">integer</td>
                            <td class="hidden-xs">0</td>
                            <td>
                                <p>Adds delay to the image loading time.</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-threshold" class="smooth-scroll">threshold</a>
                            </td>
                            <td class="hidden-xs">integer</td>
                            <td class="hidden-xs">0</td>
                            <td>
                                <p>By default images are loaded when they appear on the screen. If you want images to load earlier use threshold parameter. For instance setting a threshold to 200 end up loading the image 200 pixels before it appears on viewport.</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-animation" class="smooth-scroll">animation</a>
                            </td>
                            <td class="hidden-xs">string</td>
                            <td class="hidden-xs">"bounceIn"</td>
                            <td>
                                <p>Adds an animation when the image appears. You have access to all of the following animations created by <a href="https://daneden.me/animate/" title="animate" target="_blank">Animate.css</a> or use <code>Null</code> if you
                                    do not want any animation.</p>
                                <div>Check animate.css demo page to know the list of available animations.</div>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-event" class="smooth-scroll">event</a>
                            </td>
                            <td class="hidden-xs">string</td>
                            <td class="hidden-xs">"scroll"</td>
                            <td>
                                <p>Defines the event that will be used to trigger the image loading/update.</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-placeholder" class="smooth-scroll">placeholder</a>
                            </td>
                            <td class="hidden-xs">string (image base64)</td>
                            <td class="hidden-xs">"data:image/gif;base64..."</td>
                            <td>
                                <p>Base64 image that is used when the image is loading.</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-container" class="smooth-scroll">container</a>
                            </td>
                            <td class="hidden-xs">string (CSS selector)</td>
                            <td class="hidden-xs">window</td>
                            <td>
                                <p>You can also use this plugin for images inside scrolling container, such as <code>div</code> with scrollbar. By default the container is the window.</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-retina" class="smooth-scroll">retina</a>
                            </td>
                            <td class="hidden-xs">boolean</td>
                            <td class="hidden-xs">false</td>
                            <td>
                                <p>Enables a better quality on Retina screens.</p>
                                <p>BttrLazyLoading uses a naming convention <code>@2x</code> to display Retina images. BttrLazyLoading will therefore seek <code>"yourImage@2x.gif"</code> on Retina screens instead of <code>"yourImage.gif"</code>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-triggermanually" class="smooth-scroll">triggermanually</a>
                            </td>
                            <td class="hidden-xs">boolean</td>
                            <td class="hidden-xs">false</td>
                            <td>
                                <p>Whether or not to trigger the first image loading manually.</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-updatemanually" class="smooth-scroll">updatemanually</a>
                            </td>
                            <td class="hidden-xs">boolean</td>
                            <td class="hidden-xs">false</td>
                            <td>
                                <p>Whether or not to trigger the image update manually (needed when the window resizes for example).</p>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="#demo-backgroundcolor" class="smooth-scroll">backgroundcolor</a>
                            </td>
                            <td class="hidden-xs">string</td>
                            <td class="hidden-xs">#EEE</td>
                            <td>
                                <p>Displays a background color before loading the image.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>xs</td>
...
height : 100
                            ...
                            <td>
                                <p>Image Object for Large Desktop</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
	...
	placeholder: 'test'
            ...
            <section id="demos">
                ...
                <div class="alert alert-info">
                    <p><b>Plugin dependencies:</b> BttrLazyLoading depends on jQuery (meaning jQuery must be included <strong>before</strong> the plugin files) and <a href="https://github.com/daneden/animate.css" target="_blank">Animate.css</a> (optional)
                        for animations..</p>
                </div>
...
&lt;script src=&quot;jquery.bttrlazyloading.min.js&quot;&gt;&lt;/script&gt;</code></pre>
...
/&gt;</code></pre>
                <p>Surprise that there is no <code>src</code> attribute? Answer <a href="#tip-nosrc" class="smooth-scroll">here</a>
                </p>
                <div class="alert alert-warning">A 2 seconds delay has been added to all images for the demos.</div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Type: Integer, Default: 0</b>
                        </div>
                        <h3 id="demo-delay">
	...
	threshold: 200
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Type: String, Default: "bounceIn"</b>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <p>Here we will use the 'rollIn' animation to show how to overwrite the default "bounceIn" animation.</p>
                                <pre><code class="javascript">$('#yourImageId').bttrlazyloading({
	animation: 'rollIn'
});</code></pre>
                            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Type: String, Default: "scroll"</b>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <p>By default the updating event <code>window.onscroll</code>. Using the "event" option you can listen to any window event such as "keydown" or "mousedown".</p>
                                <p>Press a key on your keyboard to load the image beside (if the image is already loaded, it means you have already pressed a key on your keyboard).</p>
                                <pre><code class="javascript">$('#yourImageId').bttrlazyloading({
	event: 'keydown'
});</code></pre>
                            </div>
	...
	placeholder: 'data:image/gif;base64,R0lGODlhMgAyAKUAAO7u...'
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Type: String(Css selector), Default: window</b>
                        </div>
                        <h3 id="demo-container">container</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div id="option-container-wrapper">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In cursus quam nec auctor placerat. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla ut metus malesuada, congue
                                        sem quis, aliquet risus. Pellentesque eget odio sed nibh imperdiet porta. Maecenas quis volutpat diam, at tempor sem. Mauris consequat dui eget nunc semper lobortis. Maecenas libero dui, aliquam ut nibh in, eleifend
                                        interdum nibh. Sed ullamcorper eros in sem sollicitudin, et pharetra nisi vulputate. Pellentesque nunc tellus, aliquet quis nisi nec, venenatis tempus nibh. Donec orci nulla, fringilla ac augue eget, lacinia convallis
                                        risus.
                                    </p>
                                    <p>Sed vel dignissim turpis. Morbi posuere tortor sed purus mattis fermentum. Quisque libero arcu, sollicitudin vitae euismod vel, pharetra sit amet ante. Praesent molestie urna ut tortor pharetra venenatis. Pellentesque
                                        posuere, libero ac commodo mattis, sem orci semper erat, eget elementum ligula ante vel metus. Nunc non odio sit amet justo adipiscing iaculis. Duis sodales, dolor sit amet convallis tincidunt, purus velit tristique
                                        lorem, at convallis ligula ligula sit amet ligula. Suspendisse mauris ligula, tristique non dui id, laoreet rhoncus tellus.</p>
	...
	container: '#option-container-wrapper'
                ...
                <div class="panel panel-default" id="panel-option-retina">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Type: Boolean, Default: false</b>
                        </div>
                        <h3 id="demo-retina">
...
retina: true
	...
	triggermanually: true
                            ...
                            <pre><code class="javascript">$('#yourImageId').trigger('bttrlazyloading.load');</code></pre>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
	...
	updatemanually: true
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Type: String, Default: #EEE</b>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-6 col-sm-6 col-lg-6">
                            <img id="img-option-backgroundcolor-blue" class="img-option-backgroundcolor bttrlazyloading" data-bttrlazyloading-xs-src="demo/img/blue-720x200.jpg" data-bttrlazyloading-sm-src="demo/img/blue-360x200.jpg" data-bttrlazyloading-md-src="demo/img/blue-470x200.jpg"
                            data-bttrlazyloading-lg-src="demo/img/blue-570x200.jpg" />
                            <br/>
                            <img id="img-option-backgroundcolor-orange" class="img-option-backgroundcolor bttrlazyloading" data-bttrlazyloading-xs-src="demo/img/orange-720x200.jpg" data-bttrlazyloading-sm-src="demo/img/orange-360x200.jpg" data-bttrlazyloading-md-src="demo/img/orange-470x200.jpg"
                            data-bttrlazyloading-lg-src="demo/img/orange-570x200.jpg" />

                            <br/>
                            <img id="img-option-backgroundcolor-green" class="img-option-backgroundcolor bttrlazyloading" data-bttrlazyloading-xs-src="demo/img/green-720x200.jpg" data-bttrlazyloading-sm-src="demo/img/green-360x200.jpg" data-bttrlazyloading-md-src="demo/img/green-470x200.jpg"
                            data-bttrlazyloading-lg-src="demo/img/green-570x200.jpg" />

                            <h3>PNG support (transparent background)</h3>
                            <img id="img-option-backgroundcolor-transparent" class="img-option-backgroundcolor bttrlazyloading" data-bttrlazyloading-xs-src="demo/img/transparent-720x200.png" data-bttrlazyloading-sm-src="demo/img/transparent-360x200.png" data-bttrlazyloading-md-src="demo/img/transparent-470x200.png"
...
$('#yourImageId').bttrlazyloading({
	...
	animation: 'fadeIn'
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td>ranges</td>
                            <td class="hidden-xs">object</td>
                            <td class="hidden-xs"><pre><code class="json">{<br/> 'xs' : 767,<br/> 'sm' : 768,<br/> 'md' : 992,<br/> 'lg' : 1200<br/> }</code></pre>
                            </td>
                            <td>
                                <p>Ranges follows Bootstrap 3 grid sizes. <b>xs</b> for phones (
                                    <768px), <b>sm</b> for small devices tablets (≥768px), <b>md</b> for medium devices desktops (≥992px) and <b>lg</b> for large devices desktops (≥1200px).</p>
            ...
            <section id="methods">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Returns: $(img)</b>
                        </div>
...
$('#yourImageId').bttrlazyloading('destroy');</code></pre>
...
$('#yourImageId').bttrlazyloading('destroy').remove();</code></pre>
                    </div>
                </div>
            </section>
            <section id="global-methods">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-right"><b>Returns: bttrlazyloading Global</b>
                        </div>
                        <h3 id="global-method-setRanges">setRanges()</h3>
                    </div>
                    <div class="panel-body">
	...
	lg: 1200
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h3 id="global-method-setOptions">setOptions()</h3>
                    </div>
                    <div class="panel-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>This event is triggered when the image loads. You can trigger it manually like this: <pre><code class="javascript">$('#yourImageId').trigger('bttrlazyloading.load');</code></pre>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>This event is triggered when none of the images (xs, sm, md and lg) exist. The classic "error" event could therefore be triggered up to 8 times (4 times for a normal screen and 8 times for a Retina screen) while "bttrlazyloading.error"
                                    will be triggered only once.</p>
                                <p>More information in the option section: <a href="#demo-onError" class="smooth-scroll">onError</a>
                                </p>
                            </td>
                        </tr>
                    </tbody>
...
/&gt;</code></pre>
                ...
                <p>You may have noticed that none of our image elements have a "src" attribute. Well, that is normal! As describe here by the Smashing Magazine, the browsers preload the images even before the <code>document ready</code> event, which make
                    it impossible for this plugin to process the information before the image loads.</p>
...
&lt;/noscript&gt;</code></pre>
                <p>IE 9 appears to need this CSS</p>
                <pre><code class="css">noscript {
	display: block;
}
</code></pre>
